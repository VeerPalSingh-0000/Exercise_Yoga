...
const Dashboard = () => {
  ...
  const { fixedExercises, setFixedExercises, saveExercises } =
    useFixedExercises();
  ...
  const handleRemoveFixedExercise = (indexToRemove) => {
    setTempFixedExercises(
      tempFixedExercises.filter((_, index) => index !== indexToRemove)
    );
  };
        ...
        <main className="pt-24 pb-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    <div className="bg-gray-900 p-6 rounded-xl shadow-lg lg:col-span-1 flex flex-col border border-gray-700">
                        <h3 className="text-lg font-semibold mb-4 text-gray-100 flex items-center">
                            <FiTrendingUp className="mr-2 text-emerald-400" /> Workout Trend
                            (7 Days)
                        </h3>
                ...
                <div className="bg-gray-900 p-6 rounded-xl shadow-lg mb-8 border border-gray-700">
                    <h3 className="text-xl font-semibold text-gray-100 flex items-center mb-6">
                        <FaSeedling className="mr-3 text-green-400" />
                        Today's Nutrition
                    </h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-8">
                    <div className="lg:col-span-3 bg-gray-900 p-6 rounded-xl shadow-lg border border-gray-700">
                        <div className="flex justify-between items-center mb-5">
                            <h3 className="text-xl font-semibold text-gray-100 flex items-center">
                                <FaTable className="mr-3 text-emerald-400" /> Weekly Schedule
                            </h3>
                                ...
                                {isWeeklyPlanEditable ? (
                                    <>
                                        <button
                                            ...
                                            className="flex items-center bg-emerald-600 px-4 py-1.5 rounded-md hover:bg-emerald-500 text-sm font-medium"
                                        >
                                            <FiSave className="mr-1.5" /> Save
                                        </button>
                                        <button
                                            onClick={() => setIsWeeklyPlanEditable(false)}
                                            className="flex items-center bg-gray-600 px-4 py-1.5 rounded-md hover:bg-gray-500 text-sm font-medium"
                                        >
                                    ...
                                    <button
                                        ...
                                        className="flex items-center bg-yellow-500 px-4 py-1.5 rounded-md hover:bg-yellow-400 text-sm font-medium text-gray-900"
                                    >
                                        <FiEdit className="mr-1.5" /> Change
                                    </button>
                                )}
                            </div>
                        </div>
                    ...
                    <div
                        className="lg:col-span-2 bg-gray-900 p-6 rounded-xl shadow-lg border border-gray-700 flex flex-col"
                        style={{ height: "50%" }}
                    >
                        <div className="flex justify-between items-center mb-5">
                            <h3 className="text-xl font-semibold text-gray-100 flex items-center">
                                <GiBiceps className="mr-3 text-emerald-400" /> Daily Routine
                            </h3>
                            <div className="flex items-center space-x-2">
                                {isDailyPlanEditable ? (
                                    <>
                        ...
                        <div
                            className="flex flex-col gap-3 overflow-y-auto px-4"
                            style={{ flex: 1 }}
                        >
                            ...
                            {isDailyPlanEditable ? (
                                <>
                                    <select
                                        value={tempFixedExercises[0] || ""}
                                        onChange={(e) => {
                                            const newArr = [...tempFixedExercises];
                                            newArr[0] = e.target.value || undefined;
                                            setTempFixedExercises(newArr);
                                        }}
                                        className="bg-gray-700 p-2 rounded text-sm capitalize"
                                    >
                                        <option value="">- Empty -</option>
                                        {AVAILABLE_EXERCISES.map((ex) => (
                                            <option key={ex} value={ex} className="capitalize">
                                    ...
                                    <select
                                        value={tempFixedExercises[1] || ""}
                                        onChange={(e) => {
                                            const newArr = [...tempFixedExercises];
                                            newArr[1] = e.target.value || undefined;
                                            setTempFixedExercises(newArr);
                                        }}
                                        className="bg-gray-700 p-2 rounded w-full text-sm capitalize"
                                    >
                                    ...
                                    <select
                                        value={tempFixedExercises[2] || ""}
                                        onChange={(e) => {
                                            const newArr = [...tempFixedExercises];
                                            newArr[2] = e.target.value || undefined;
                                            setTempFixedExercises(newArr);
                                        }}
                                        className="bg-gray-700 p-2 rounded w-full text-sm capitalize"
                                    >
                                ...
                                tempFixedExercises.length > 0 &&
                                tempFixedExercises.some((e) => e) ? (
            ...
            <div className="bg-gray-900 p-6 rounded-xl shadow-lg text-center border border-gray-700">
                <h3 className="text-xl font-semibold mb-4 text-gray-100 flex items-center justify-center">
                ...
                <button
                    ...
                    className="inline-flex items-center bg-purple-600 px-6 py-2.5 rounded-md font-semibold text-white hover:bg-purple-500"
                >
