...
  // ======================== RENDER FUNCTIONS ========================
  const renderHeader = () => (
    <div className="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-lg border-b border-slate-700 shadow-sm">
      <div className="max-w-6xl mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-100 flex items-center">
...
          className="w-full px-4 py-3 pl-10 bg-slate-800 border border-slate-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
        />
...
    <div className="mb-6 bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-xl p-4">
...
          ✨ Quote of the Day
        </h3>
        <blockquote className="text-slate-500 italic text-sm sm:text-base leading-relaxed">
          "{dailyQuote}"
        </blockquote>
      </div>
    </div>
...
          </p>
          <div className="w-64 bg-blue-800 rounded-full h-3 mb-4 overflow-hidden">
            <div
...
          </div>
          <div className="text-sm font-semibold text-pink-500">Favorites</div>
        </div>
...
            }
            className="px-3 py-1 text-white rounded-lg bg-slate-700 border border-slate-600 text-sm"
...
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-gray-500 mb-6">⚙️ Settings</h2>
...
          <div className="flex items-center justify-between">
            <span className="text-gray-300">Auto-expand Today's Routine</span>
            <button
...
            <div
              className="px-6 py-4 bg-gradient-to-r from-purple-900/30 to-indigo-900/30 flex justify-between items-center cursor-pointer"
              onClick={() => setShowAllPranayama(!showAllPranayama)}
            >
              <h2 className="text-xl font-bold text-gray-100 flex items-center">
                🧘‍♀️ All Pranayama Techniques
                <span className="ml-2 bg-purple-800 text-purple-200 px-2 py-1 rounded-full text-sm">
...
                    <div
                      key={pranKey}
                      className="bg-slate-700 rounded-lg p-4 hover:shadow-md transition-all"
                    >
...
                        <div className="bg-slate-600 rounded-lg p-4 mt-3 border-l-4 border-purple-400">
                          <h6 className="font-semibold text-gray-200 mb-2">
                            How to practice:
                          </h6>
...
                      <span className="font-semibold not-italic text-gray-200">
                        Focus:
                      </span>{" "}
                      {dayData.focus}
                    </p>
...
                                  }}
                                />
                                <div className="hidden text-gray-400 text-sm mt-2">
                                  Image not available
                                </div>
                              </div>
                            )}
...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                  <div className="flex-1 min-w-0">
                                    <h5 className="text-lg font-semibold text-purple-300 break-words">
                                      {pranayama.name}
                                      <span className="text-sm font-normal text-gray-400 ml-2">
                                        ({pranayama.Sanskrit})
                                      </span>
...
                                {isHowToExpanded &&
                                  Array.isArray(pranayama.howTo) && (
                                    <div className="bg-slate-600 rounded-lg p-4 border-l-4 border-purple-400">
                                      <h6 className="font-semibold text-gray-200 mb-2">
                                        How to practice:
                                      </h6>
                                      <ol className="list-decimal list-inside space-y-1 text-sm text-gray-300">
...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-slate-900/90 backdrop-blur-lg border-t border-slate-700 px-4 py-2">
